...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 10; // Bu dükkanın ID'si 
...
<body>
    ...
    <div class="container">
        <h1>Maslak Turbo</h1>
        <p class="text-center text-muted">Turbo sistemleri ile aracınızda gücü artırın</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/maslakturbo/turbo2.jpg" class="d-block w-100" alt="Maslak Turbo 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakturbo/turbo1.jpg" class="d-block w-100" alt="Maslak Turbo 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakturbo/turbo3.jpg" class="d-block w-100" alt="Maslak Turbo 3">
                </div>
            </div>
