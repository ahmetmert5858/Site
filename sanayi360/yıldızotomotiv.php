...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 39; // Bu dükkanın ID'si 
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Yıldız Otomotiv</h1>
        <p class="text-center text-muted">Otomotiv sektöründe profesyonel çözümler</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/yıldızotomotiv/yıldız1.jpg" class="d-block w-100" alt="Maslak Oto Göçük 3">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/yıldızotomotiv/yıldız.jpg" class="d-block w-100" alt="Maslak Oto Göçük 2">
            </div>
