...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 15; // Bu dükkanın ID'si 
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Akademi Ekspertiz</h1>
        <p class="text-center text-muted">Aracınızın detaylı ekspertiz raporları için</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/akademiekspertiz/akademi1.webp" class="d-block w-100" alt="akts motor 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/akademiekspertiz/akademi.jpg" class="d-block w-100" alt="akts motor 2">
                </div>
            </div>
