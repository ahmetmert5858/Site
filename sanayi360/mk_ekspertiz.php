...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 11; // Bu dükkanın ID'si 
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Mk Oto Ekspertiz</h1>
        <p class="text-center text-muted">Araçlarınızı uzman kadromuzla detaylı olarak inceleyip ekspertiz raporları hazırlıyoruz</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/mkotoekspertiz/ekspertiz1.jpg" class="d-block w-100" alt="Ekspertiz 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/mkotoekspertiz/ekspertiz2.jpg" class="d-block w-100" alt="Ekspertiz 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/mkotoekspertiz/ekspertiz3.jpg" class="d-block w-100" alt="Ekspertiz 3">
                </div>
            </div>
