...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 33; // Bu dükkanın ID'si 
    ...
    <div class="container">
        ...
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="SanayiGörseller/prestijklima/prestij1.jpg" class="d-block w-100" alt="akts motor 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/prestijklima/prestij.jpg" class="d-block w-100" alt="akts motor 2">
                </div>
            </div>
