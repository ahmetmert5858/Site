...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Maslak Oto Şanzıman</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        ...
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="SanayiGörseller/maslakotoşanzıman/şanzıman1.jpg" class="d-block w-100" alt="Maslak Oto Şanzıman 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotoşanzıman/şanzıman2.jpg" class="d-block w-100" alt="Maslak Oto Şanzıman 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotoşanzıman/şanzıman3.jpg" class="d-block w-100" alt="Maslak Oto Şanzıman 3">
                </div>
            </div>
