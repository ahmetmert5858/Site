...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    $yorum = trim($_POST['comment']); // Boşlukları temizle
    $kullanici_adi = $_SESSION['kullanici_adi']; // Oturumdan kullanıcı adı al
    $dükkan_id = 6; // Bu dükkanın ID'si 
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Maslak Oto Döşeme</h1>
        <p class="text-center text-muted">Özel oto döşeme hizmetleri ile aracınızın iç mekanını yenileyin</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/maslakotodöşeme/otodöseme2.jpg" class="d-block w-100" alt="Maslak Oto Döşeme 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotodöşeme/otodöseme1.jpg" class="d-block w-100" alt="Maslak Oto Döşeme 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotodöşeme/otodöseme3.jpg" class="d-block w-100" alt="Maslak Oto Döşeme 3">
                </div>
            </div>
