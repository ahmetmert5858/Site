...
<body>
    ...
    <!-- Content -->
    <div class="container">
        <h1 class="text-center">Hasan Egzoz</h1>
        ...
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="SanayiGörseller/hasanegzoz/hasan1.jpg" class="d-block w-100" alt="Hasan Egzoz 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/hasanegzoz/hasan2.jpg" class="d-block w-100" alt="Hasan Egzoz 2">
                </div>
            </div>
...
<div class="mt-5">
    <div class="card shadow-sm">
        ...
        <div class="comment-section">
            <h4>Yorumlar</h4>
            <?php
            // Yorumları veritabanından al ve listele (Hasan Egzoz'a ait yorumlar, dükkan_id = 2)
$dükkan_id = 2; // Hasan Egzoz'un dükkan ID'si
