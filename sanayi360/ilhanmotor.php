...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 26; // Bu dükkanın ID'si 
...
<body>
    ...
    <div class="container">
        <h1>İlhan Motor</h1>
        <p class="text-center text-muted">Motor sektöründe profesyonel çözümler</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/ilhanmotor/ilhan.jpg" class="d-block w-100" alt="Maslak Oto Göçük 3">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/ilhanmotor/ilhan1.jpg" class="d-block w-100" alt="Maslak Oto Göçük 2">
                </div>
            </div>
