...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 12; // Bu dükkanın ID'si 
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pdrc Göçük Düzeltme</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Pdrc Göçük Düzeltme</h1>
        <p class="text-center text-muted">Uzman ekibimizle aracınızdaki göçükleri profesyonelce düzeltiyoruz</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/pdrcgöçükdüzeltme/pdrc1.jpg" class="d-block w-100" alt="Pdrc Göçük Düzeltme 1">
        </div>
        <div class="carousel-item">
            <img src="SanayiGörseller/pdrcgöçükdüzeltme/pdrc2.jpg" class="d-block w-100" alt="Pdrc Göçük Düzeltme 2">
        </div>
        <div class="carousel-item">
            <img src="SanayiGörseller/pdrcgöçükdüzeltme/pdrc3.jpg" class="d-block w-100" alt="Pdrc Göçük Düzeltme 3">
                </div>
            </div>
