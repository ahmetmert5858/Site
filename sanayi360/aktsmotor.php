...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 13; // Bu dükkanın ID'si 
    ...
    <div class="container">
        ...
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="SanayiGörseller/aktsmotor/202302242.jpg" class="d-block w-100" alt="akts motor 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/aktsmotor/202302241.jpg" class="d-block w-100" alt="akts motor 2">
                </div>
            </div>
