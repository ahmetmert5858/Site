...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 23; // Bu dükkanın ID'si 
    ...
    <div class="container">
        ...
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="SanayiGörseller/günesotomotiv/günes1.jpg" class="d-block w-100" alt="Maslak Oto Göçük 3">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/günesotomotiv/günes.jpg" class="d-block w-100" alt="Maslak Oto Göçük 2">
                </div>
            </div>
