...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 19; // Bu dükkanın ID'si 
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Detay Ekspertiz</h1>
        <p class="text-center text-muted">Aracınızın tüm detayları için güvenilir ekspertiz</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/detayekspertiz/detay1.jpg" class="d-block w-100" alt="akts motor 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/detayekspertiz/detay.jpg" class="d-block w-100" alt="akts motor 2">
                </div>
            </div>
