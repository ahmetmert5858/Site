...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 18; // Bu dükkanın ID'si 
...
<body>
    ...
    <div class="container">
        <h1>Bey Motor</h1>
        <p class="text-center text-muted">Yenilikçi motor yenileme çözümleri</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/beymotor/beymotor1.jpg" class="d-block w-100" alt="akts motor 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/beymotor/beymotor.jpg" class="d-block w-100" alt="akts motor 2">
                </div>
            </div>
