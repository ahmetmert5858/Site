...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Maslak Oto Göçük</h1>
        <p class="text-center text-muted">Profesyonel oto göçük düzeltme hizmetiyle aracınızın dış yüzeyini yenileyin</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/maslakotogöçük/otogöçük3.jpg" class="d-block w-100" alt="Maslak Oto Göçük 3">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotogöçük/otogöçük2.jpg" class="d-block w-100" alt="Maslak Oto Göçük 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotogöçük/otogöçük1.jpg" class="d-block w-100" alt="Maslak Oto Göçük 1">
                </div>
            </div>
