...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    $dükkan_id = 16; // Bu dükkanın ID'si 
...
<body>
    ...
    <div class="container">
        <h1>Ak Egzoz</h1>
        <p class="text-center text-muted">Egzoz sistemlerinde profesyonel çözümler</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/akegzoz/akegzoz.webp" class="d-block w-100" alt="akts motor 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/akegzoz/akegzoz.jpg" class="d-block w-100" alt="akts motor 2">
                </div>
            </div>
