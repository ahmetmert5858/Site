...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['speed']) && isset($_POST['price'])) {
    ...
    $price = $_POST['price'];
    $kullanici_adi = $_SESSION['kullanici_adi']; // Oturumdan kullanıcı adı al
    $dükkan_id = 4; // Dükkan ID

    if (!empty($speed) && !empty($price)) {
        ...
        $rating_message = "Tüm alanları doldurun.";
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Maslakland Otomotiv</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Maslakland Otomotiv</h1>
        <p class="text-center text-muted">Aracınız için her türlü otomotiv hizmeti</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/maslaklandotomotiv/maslakland3.jpg" class="d-block w-100" alt="Maslakland Otomotiv 3">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslaklandotomotiv/maslakland2.jpg" class="d-block w-100" alt="Maslakland Otomotiv 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslaklandotomotiv/maslakland1.jpg" class="d-block w-100" alt="Maslakland Otomotiv 1">
                </div>
            </div>
