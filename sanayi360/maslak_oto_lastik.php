...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Maslak Oto Lastik Rotbalans</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Maslak Oto Lastik</h1>
        <p class="text-center text-muted">Profesyonel lastik rotbalans hizmeti ile güvenli sürüş sağlayın</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/maslakotolastikrotbalans/rotbalans2.jpg" class="d-block w-100" alt="Maslak Oto Göçük 3">
                </div>
                <div class="carousel-item">
                <img src="SanayiGörseller/maslakotolastikrotbalans/rotbalans1.jpg" class="d-block w-100" alt="Maslak Oto Lastik Rotbalans 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakotolastikrotbalans/rotbalans2.jpg" class="d-block w-100" alt="Maslak Oto Lastik Rotbalans 2">
                </div>
            </div>
