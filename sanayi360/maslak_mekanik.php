...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Maslak Mekanik</h1>
        <p class="text-center text-muted">Her türlü mekanik arıza ve bakım hizmeti</p>
        ...
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="SanayiGörseller/maslakmekanik/mekanik2.jpg" class="d-block w-100" alt="Maslak Mekanik 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/maslakmekanik/mekanik3.jpg" class="d-block w-100" alt="Maslak Mekanik 3">
                </div>
            </div>
