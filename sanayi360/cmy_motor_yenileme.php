...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cmy Motor Yenileme</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Content -->
    <div class="container">
        <h1>Cmy Motor Yenileme</h1>
        <p class="text-center text-muted">Kaliteli motor yenileme hizmetleri ile araçlarınız için en iyi çözümler.</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="SanayiGörseller/cmymotoryenileme/cmy1.jpg" class="d-block w-100" alt="Cmy Motor Yenileme 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/cmymotoryenileme/cmy2.jpg" class="d-block w-100" alt="Cmy Motor Yenileme 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/cmymotoryenileme/cmy3.jpg" class="d-block w-100" alt="Cmy Motor Yenileme 3">
                </div>
            </div>
