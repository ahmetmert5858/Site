...
// Oturumdan kullanıcı adını alın
...
<body>
    ...
    <div class="container">
        <h1>Kar Oto Klima</h1>
        <p class="text-center text-muted">Aracınız için profesyonel klima hizmetleri</p>

        <!-- Image Gallery -->
        <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src="SanayiGörseller/karotoklima/kar1.jpg" class="d-block w-100" alt="Kar Oto Klima 1">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/karotoklima/kar2.jpg" class="d-block w-100" alt="Kar Oto Klima 2">
                </div>
                <div class="carousel-item">
                    <img src="SanayiGörseller/karotoklima/kar3.jpg" class="d-block w-100" alt="Kar Oto Klima 3">
                </div>
            </div>
